 ...
 public class AudioDistortionFilterCommander :IAudioCommandable
 {
    ...
    private AudioCommand<AudioDistortionFilter>CommandFactory(int enumeratedProp)
    {
        ...
        switch(commandPropTarget){
            ...
            return nextCommand;
               case AudioDistortionFilterMembers.tag:
                nextCommand = new AudioDistortionFilterCmdTag(Target);
            return nextCommand;
           default:
            return null; 
      }
		...
		public class AudioDistortionFilterCmdEnabled : AudioCommand< AudioDistortionFilter >,IAudioCommand< bool >
{
	...
	Target.enabled = InitialValue;
		...
		public class AudioDistortionFilterCmdTag : AudioCommand< AudioDistortionFilter >,IAudioCommand< string >
{
	...
	public AudioDistortionFilterCmdTag(AudioDistortionFilter target){
		Target = target;
	}
	...
	public int TargetPropEnum()
	{
		return (int)AudioDistortionFilterMembers.tag;
	}
