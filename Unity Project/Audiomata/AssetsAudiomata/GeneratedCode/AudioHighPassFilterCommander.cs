 ...
 public class AudioHighPassFilterCommander :IAudioCommandable
 {
    ...
    private AudioCommand<AudioHighPassFilter>CommandFactory(int enumeratedProp)
    {
        ...
        switch(commandPropTarget){
            ...
            return nextCommand;
               case AudioHighPassFilterMembers.tag:
                nextCommand = new AudioHighPassFilterCmdTag(Target);
            return nextCommand;
           default:
            return null; 
      }
		...
		public class AudioHighPassFilterCmdEnabled : AudioCommand< AudioHighPassFilter >,IAudioCommand< bool >
{
	...
	Target.enabled = InitialValue;
		...
		public class AudioHighPassFilterCmdTag : AudioCommand< AudioHighPassFilter >,IAudioCommand< string >
{
	...
	public AudioHighPassFilterCmdTag(AudioHighPassFilter target){
		Target = target;
	}
	...
	public int TargetPropEnum()
	{
		return (int)AudioHighPassFilterMembers.tag;
	}
