 ...
 public class AudioReverbFilterCommander :IAudioCommandable
 {
    ...
    private AudioCommand<AudioReverbFilter>CommandFactory(int enumeratedProp)
    {
        ...
        switch(commandPropTarget){
            ...
            return nextCommand;
               case AudioReverbFilterMembers.tag:
                nextCommand = new AudioReverbFilterCmdTag(Target);
            return nextCommand;
           default:
            return null; 
      }
		...
		public class AudioReverbFilterCmdEnabled : AudioCommand< AudioReverbFilter >,IAudioCommand< bool >
{
	...
	Target.enabled = InitialValue;
		...
		public class AudioReverbFilterCmdTag : AudioCommand< AudioReverbFilter >,IAudioCommand< string >
{
	...
	public AudioReverbFilterCmdTag(AudioReverbFilter target){
		Target = target;
	}
	...
	public int TargetPropEnum()
	{
		return (int)AudioReverbFilterMembers.tag;
	}
