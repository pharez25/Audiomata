 ...
 public class AudioReverbZoneCommander :IAudioCommandable
 {
    ...
    private AudioCommand<AudioReverbZone>CommandFactory(int enumeratedProp)
    {
        ...
        switch(commandPropTarget){
            ...
            return nextCommand;
               case AudioReverbZoneMembers.tag:
                nextCommand = new AudioReverbZoneCmdTag(Target);
            return nextCommand;
           default:
            return null; 
      }
		...
		public class AudioReverbZoneCmdEnabled : AudioCommand< AudioReverbZone >,IAudioCommand< bool >
{
	...
	Target.enabled = InitialValue;
		...
		public class AudioReverbZoneCmdTag : AudioCommand< AudioReverbZone >,IAudioCommand< string >
{
	...
	public AudioReverbZoneCmdTag(AudioReverbZone target){
		Target = target;
	}
	...
	public int TargetPropEnum()
	{
		return (int)AudioReverbZoneMembers.tag;
	}
