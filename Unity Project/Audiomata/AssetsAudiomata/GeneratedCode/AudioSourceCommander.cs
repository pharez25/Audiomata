 ...
 public class AudioSourceCommander :IAudioCommandable
 {
    ...
    private AudioCommand<AudioSource>CommandFactory(int enumeratedProp)
    {
        ...
        switch(commandPropTarget){
            ...
            return nextCommand;
               case AudioSourceMembers.tag:
                nextCommand = new AudioSourceCmdTag(Target);
            return nextCommand;
           default:
            return null; 
      }
		...
		public class AudioSourceCmdEnabled : AudioCommand< AudioSource >,IAudioCommand< bool >
{
	...
	Target.enabled = InitialValue;
		...
		public class AudioSourceCmdTag : AudioCommand< AudioSource >,IAudioCommand< string >
{
	...
	public AudioSourceCmdTag(AudioSource target){
		Target = target;
	}
	...
	public int TargetPropEnum()
	{
		return (int)AudioSourceMembers.tag;
	}
